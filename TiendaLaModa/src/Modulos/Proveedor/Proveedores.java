...
public class Proveedores extends javax.swing.JFrame {
    ...
    private void BUSCARMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BUSCARMouseClicked
        ced= TXT_CED.getText();
        SQL="SELECT * FROM proveedores WHERE(cedula='" + ced+"')"; //Consulta de un único cliente delimitado con WHERE
        ...
        try{
            ...
            while(result.next()){ 
                ...
                vendor= new Proveedor(result.getString(3), result.getString(1), result.getString(2),result.getString(4),result.getString(5),result.getString(6),result.getString(7)); //null de credenciales para acceder al sistema
