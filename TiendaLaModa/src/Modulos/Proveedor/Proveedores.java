...
public class Proveedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PROVEEDORES.setBackground(new java.awt.Color(0, 204, 204));
        PROVEEDORES.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        PROVEEDORES.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Cédula", "Nombre", "Tipo", "Teléfono", "Dirección", "Correo", "Productos"
            }
        ));
    ...
    private void TODOMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TODOMouseClicked
        ...
        String []datos=new String[7]; //Vector/lista para insertarlas en el JTable
        try{
            ...
            CallableStatement ver = General.database.prepareCall("{call VER_PROVEEDORES(?)}");
    ...
    private void BUSCARMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BUSCARMouseClicked
        ...
        String []datos=new String[7]; //Vector de datos
        try{
            //Jtable
            DefaultTableModel modelo = new DefaultTableModel();
            modelo.addColumn("Cédula");
            ...
            while(rs.next()){ 
                ...
                vendor= new Proveedor(rs.getString(3), rs.getString(1), rs.getString(2),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7)); //null de credenciales para acceder al sistema
    ...
    private void MODIFICARMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MODIFICARMouseClicked
        Modificar_Proveedor ventana=new Modificar_Proveedor(vendor); //Al instanciar la ventana se le pasa un objeto cliente (El creado al buscar)
    ...
    private void ELIMINARMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ELIMINARMouseClicked
        int opt= JOptionPane.showConfirmDialog(null, "¿Está seguro de eliminar a este proveedor?", "ADVERTENCIA",JOptionPane.YES_NO_OPTION);
    ...
    private void INSERTARMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_INSERTARMouseClicked
        Insertar_Proveedor ventana = new Insertar_Proveedor();
        ventana.setVisible(true);
        ventana.setLocationRelativeTo(null);
        this.setVisible(false);
    ...
    private void PROVEEDORESMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PROVEEDORESMouseClicked
        try{
           ced=PROVEEDORES.getValueAt(PROVEEDORES.getSelectedRow(), 0).toString();
           ...
           CallableStatement buscar = General.database.prepareCall("{call BUSCAR_PROVEEDOR(?,?)}");
            ...
            buscar.execute();
            ResultSet rs=(ResultSet)buscar.getObject(2);
           SQL="SELECT * FROM proveedores WHERE(cedula='" + ced+"')";
           Statement state=General.database.createStatement();
           ResultSet result=state.executeQuery(SQL);
           result.next();
           vendor= new Proveedor(result.getString(3), result.getString(1), result.getString(2),result.getString(4),result.getString(5),result.getString(6),result.getString(7));
           MODIFICAR.setVisible(true);
           ELIMINAR.setVisible(true);
            }
            catch(Exception ex){
