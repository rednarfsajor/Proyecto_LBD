...
import Clases.EmpleadoU;
import static java.lang.System.exit;

public class Modificar_Empleado extends javax.swing.JFrame {

    EmpleadoU employee;
    public Modificar_Empleado(EmpleadoU employee) {
        this.employee=employee; //Al se crearse la ventana se asocia el empleado a modificar en el atributo
        initComponents();
        //Conexion db= new Conexion();
        //database=db.getConnection();
        getEmpleado(); //Obtiene los datos del objeto empleado para colocarlo en los TXT editables
    }
    ...
    public void getEmpleado(){ //Metodo para rellenar los TXT con los datos del objeto empleado obtenido al buscarlo
        
        try{
            TXT_CED.setText(employee.getCedula());
            TXT_NOMBRE.setText(employee.getNombre());
            TXT_TIPO.setText(employee.getTipo());
            TXT_TELEFONO.setText(employee.getTelefono());
            TXT_DIRECCION.setText(employee.getDireccion());
            TXT_CORREO.setText(employee.getCorreo());
            TXT_PUESTO.setText(employee.getPuesto());
            TXT_SALARIO.setText(employee.getSalario());
        }
        catch(Exception ex){
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(TXT_SALARIO, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void MODIFICARMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MODIFICARMouseClicked
      if(TXT_CED.getText().length()==9&&!TXT_NOMBRE.getText().isBlank()){
        ...
        empleado.add(TXT_NOMBRE.getText());
        empleado.add(TXT_TELEFONO.getText());
        empleado.add(TXT_DIRECCION.getText());
        empleado.add(TXT_CORREO.getText());
        empleado.add(TXT_PUESTO.getText());
