...
--SP Para obtener listado de productos por codigo

CREATE OR REPLACE PROCEDURE OBTENER_PRODUCTOS( CURSOR_PRODUCTOS OUT SYS_REFCURSOR) AS
BEGIN
OPEN CURSOR_PRODUCTOS FOR
SELECT CODIGO FROM PRODUCTOS;
END;

--SP Para obntener las cantidades de los productos

CREATE OR REPLACE PROCEDURE OBTENER_CANTIDADES_PRODUCTOS(ITEM IN INT, CURSOR_CANTIDADES OUT SYS_REFCURSOR) AS
BEGIN
OPEN CURSOR_CANTIDADES FOR
SELECT CANTIDAD FROM PRODUCTOS WHERE CODIGO=ITEM;
END;
--SP Específico para obtener datos de productos

CREATE OR REPLACE PROCEDURE OBTENER_DATOS_PRODUCTOS(ITEM IN INT, CURSOR_DATOS OUT SYS_REFCURSOR) AS
BEGIN
